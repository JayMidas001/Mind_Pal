      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <p>Please ensure you're available at the scheduled time. If you need to reschedule or cancel the appointment, kindly contact us in advance.</p>
...
const therapistNotificationTemplate = (therapistName, userName, appointmentDate, appointmentTime) => {
  return `
    <!DOCTYPE html>
    <html lang="en">
    <head>
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <p><strong>Date:</strong> ${appointmentDate}</p>
          <p><strong>Time:</strong> ${appointmentTime}</p>
          <p>Please make sure to prepare accordingly. If you need to reschedule or cancel the appointment, please contact the client or our team.</p>
          <p>Best regards,<br>MindPal Team</p>
        </div>
        <div class="footer">
          <p>&copy; ${new Date().getFullYear()} MindPal. All rights reserved.</p>
